...
#https://cran.r-project.org/web/packages/openxlsx/vignettes/formatting.pdf
      ...
      openxlsx::addWorksheet(wb, "SelectedDataForChecking1", tabColour = "blue",
                       footer = c("&[Path]&[File]", NA, "&[Tab]"))
      
      openxlsx::writeDataTable(wb, "SelectedDataForChecking1", dff1019.data,
...
ABR_SDG2022_SelectedDataForChecking.data <- read_excel("Output Data/ABR_SDG2022_SelectedData.xlsx",sheet = "SelectedDataForChecking1")
