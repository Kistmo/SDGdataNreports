...
SDGregions.data <- read_excel("~/Fertility Section/SDG_Data&reports/SDG2022Data/Input Data/RegionalGroupings2018.xlsx", sheet = "M49Locations")
...
DT[AgeStart==10, .( LocID, LocName, AgeStart, AgeSpan, DataCatalogID, DataCatalogShortName, DataSourceShortName, PeriodSpan, PeriodGroupName, TimeLabel, TimeDuration, TimeMid, RecallLag, DataValue, DataProcessType, DataReliabilityName, DataTypeName,  DataSourceYear, ModelPatternName )]
...
library(dplyr)
mm <- mm %>% dplyr::mutate(DataQuality = case_when(
...
mm <- mm %>%
  ...
  dplyr::arrange(LocID, DataQuality, AgeStart, RefYear, RecallLag) %>%
...
# # https://stackoverflow.com/questions/58331771/issue-with-pivot-longer-and-pivot-wider
# 
# library(dplyr)
# library(readr)
# library(utils)
...
#   tidyr::pivot_wider(
#     names_from = AgeStart, 
#     values_from = c(DataValue,  AgeStart, AgeSpan, DataCatalogID,DataCatalogShortName,
#                     DataSourceShortName, PeriodSpan, PeriodGroupName, TimeLabel, TimeDuration,
#                     RecallLag, DataProcessType, DataReliabilityName, DataTypeName, 
#                     DataSourceYear, ModelPatternName, DataQuality)) %>%
#     #group_by(LocID, RefYear, RecallLag) %>% 
#   arrange(LocID, RefYear) %>%
#   #https://www.marsja.se/how-to-remove-a-column-in-r-using-dplyr-by-name-and-index/#:~:text=For%20example%2C%20if%20you%20want,(Your_Dataframe%2C%20%2DX)%20.
#   select(-starts_with(c("AgeSpan", "AgeStart","TimeDuration"))) %>%
#       plyr::rename(., c("DataValue_10"="ABR1014", "DataValue_15"="ABR1519"))
# 
# ####________________________________________
# #Rename patterns of strings in variable/vector names of gg:
# names(dd) <- mgsub::mgsub(names(dd), c("_10", "_15"), c("_1014", "_1519"))

# Save MaxDataSourceSeries data for each age group:
saveRDS(dd_10, file="MaxDataSourceSeries_10.Rda")
saveRDS(dd_15, file="MaxDataSourceSeries_15.Rda")
...
#++++++++++++++++++++++++++++++++++++++++++++++
##Save the returned data using saveRDS:
# saveRDS(MaxDataSourceSeries.data, file="MaxDataSourceSeries.data.Rda") #Nov 10, 2021: 
##Then read it with:
# MaxDataSourceSeries.data <- readRDS(file="MaxDataSourceSeries.data.Rda") #Nov 10, 2021: 
#++++++++++++++++++++++++++++++++++++++++++++++
...
#++++++++++++++++++++++++++++++++++++++++++++++
##Save the returned data using saveRDS:
saveRDS(AllDataSourcesDemoData.data, file="AllDataSourcesDemoData.data.Rda")
##Then read it with:
